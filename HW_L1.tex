...
\urlstyle{same}
\hypersetup{
  pdftitle={Home\_work\_lecture\_1},
  pdfauthor={Zarva\_I},
  hidelinks,
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Распространенность "опытных"}
\NormalTok{prevalence\_experience }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{experience }\SpecialCharTok{==} \DecValTok{1}\NormalTok{) }\SpecialCharTok{/} \FunctionTok{nrow}\NormalTok{(df)}
\FunctionTok{cat}\NormalTok{(}\StringTok{"Распространенность “experience”:"}\NormalTok{, prevalence\_experience, }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Риск “accident” в общей группе, в группе “experience” и в группе без “experience”}
\NormalTok{all\_risk\_accident }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{accident)}
\NormalTok{risk\_accident\_experience }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{accident[df}\SpecialCharTok{$}\NormalTok{experience }\SpecialCharTok{==} \DecValTok{1}\NormalTok{] }\SpecialCharTok{==} \DecValTok{1}\NormalTok{) }\SpecialCharTok{/} \FunctionTok{sum}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{experience }\SpecialCharTok{==} \DecValTok{1}\NormalTok{)}
\NormalTok{risk\_accident\_no\_experience }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{accident[df}\SpecialCharTok{$}\NormalTok{experience }\SpecialCharTok{==} \DecValTok{0}\NormalTok{] }\SpecialCharTok{==} \DecValTok{1}\NormalTok{) }\SpecialCharTok{/} \FunctionTok{sum}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{experience }\SpecialCharTok{==} \DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
